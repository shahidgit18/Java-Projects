...
<html>
	...
	<header>
        ...
        <form>
                 <div class="row">                    
                    <div class="col-lg-2 col-lg-offset-3">Party Name</div>
...
//                    out.print(partyid);
                    if(partyid==0)
                        out.print("Please Select Party Name");
                    else{
                        li=session1.createQuery("from purchasemaster pm where pm.partyid="+partyid).list();
