<%-- 
    Document   : list_purchasedetail
    Created on : Mar 18, 2020, 1:45:21 PM
    Author     : HP
--%>
...
<html>
    <head>
        ...
        <title>List Purchase Detail</title>
	...
	<header>
		<div class="navbar navbar-default navbar-static-top">
                ...
                <br>
                <div class="row">
                    <div class="col-lg-12 col-sm-12" align="center"><h1><b>List Report Purchase Detail</b></h1></div>
                </div>
                 <div class="container">
                 <div class="row"> 
            ...
            List li=session1.createQuery("from purchasedetails").list();
