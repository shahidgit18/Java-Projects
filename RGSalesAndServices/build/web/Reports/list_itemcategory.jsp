<%-- 
    Document   : list_itemcategory
    Created on : Mar 18, 2020, 12:22:44 PM
    Author     : HP
--%>
...
<html>
    <head>
        ...
        <title>List Report Item Category</title>
	...
	<header>
		<div class="navbar navbar-default navbar-static-top">
                ...
                <br>
                <div class="row">
                    <div class="col-lg-12 col-sm-12" align="center"><h1><b>List Report Item Category</b></h1></div>
                </div>
                <div class="container">
                    <div class="row">
            ...
            out.print("<tr><th>Category Id</th><th>Name</th></tr>");
