 ...
 String  partyid,stateid,distid,cityid,partytype,partyname,partyaddress,partygstno,partytelno1,partytelno2,partyemail,partycontactp,partycontactno;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                            <div class=\"col-lg-4 col-sm-12\"><input type=\"text\" name=\"partyid\" id=\"partyid\" placeholder=\"Enter Party Id\" class=\"form-control\" style=\"width: 70%\" value=\"");
      out.print(partyid);
      out.write("\"/></div>\n");
...
if(request.getQueryString()!=null)
      ...
      out.write("                                   </div>\n");
      out.write("                                   <div align=\"center\" class=\"col-lg-4 col-sm-12 col-xs-12\">\n");
      out.write("                                       <input type=\"submit\" class=\" btn btn-warning\" name=\"btn\"  value=\"Delete\" onclick=\"return formvalidator()\"/>\n");
      out.write("                                   </div>\n");
      out.write("           ");
 }
            else{
