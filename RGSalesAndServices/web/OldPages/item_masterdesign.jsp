            ...
            <section id="contact-page">
                <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-12"><input type="text" class="form-control" style="width: 50%" id="itemid"  name="itemid" value="<%=itemid%>"/></div>
                            <div class="col-lg-2 col-sm-12"> <h4><b>Category Id</b></h4></div>
