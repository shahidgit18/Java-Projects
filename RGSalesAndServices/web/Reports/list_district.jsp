<%-- 
    Document   : list_district
    Created on : Mar 18, 2020, 1:54:10 PM
    Author     : HP
--%>
...
<html>
	...
	<header>
		<div class="navbar navbar-default navbar-static-top">
                ...
                <br>
                <div class="row">
                    <div class="col-lg-12 col-sm-12" align="center"><h1><b>List Report District</b></h1></div>
                </div>
                ...
                out.print("<table border=2 class='table' align='center' style='width: 40%'>");
                out.print("<tr><th>District Id</th><th>State Name</th><th>District Name</th></tr>");
                for(int i=0;i<li.size();i++){
                    district d=(district)li.get(i);
                    state s=(state)session1.get(state.class, d.getDistid());
                    out.print("<tr>");
