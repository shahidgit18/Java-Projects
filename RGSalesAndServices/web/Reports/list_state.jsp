<%-- 
    Document   : list_state
    Created on : Mar 18, 2020, 2:15:53 PM
    Author     : HP
--%>
...
<html>
	...
	<header>
		<div class="navbar navbar-default navbar-static-top">
                ...
                <br>
                <div class="row">
                    <div class="col-lg-12 col-sm-12" align="center"><h1><b>List Report State</b></h1></div>
                </div>
                <div class="container">
                 <div class="row"> 
            ...
            out.print("<tr><th>State Id</th><th>State Name</th></tr>");
			...
			<div id="sub-footer">
				<div class="container">
					<div class="row">
                                            <div class="col-lg-6" style="height: 140px">
							<div class="copyright">
