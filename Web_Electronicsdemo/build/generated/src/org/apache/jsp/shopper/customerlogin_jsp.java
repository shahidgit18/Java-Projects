...
public final class customerlogin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<h4 class=\"title\"><span class=\"text\"><strong>Customer</strong> Login</span></h4>\n");
      out.write("                                                \n");
      out.write("                                                \n");
      out.write("                                                                       <form action=\"customerlogincode.jsp\">\n");
      out.write("\t\t\t\t\t\t\t<fieldset>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"control-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"control-label\">Email</label>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" placeholder=\"Enter Email\" class=\"input-xlarge\" name=\"txtemail\">\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"control-group\">\n");
      ...
      out.write("                                                                        \n");
      out.write("\t\t\t\t\t\t</form>\t\n");
      out.write("                                                <a href=\"Customer.jsp\"><h5><b>New User Register\t</b>   </h5>       \n");
      out.write("                                                            \n");
      out.write("                                                            \n");
      out.write("                                                           \n");
      out.write("                                                \n");
