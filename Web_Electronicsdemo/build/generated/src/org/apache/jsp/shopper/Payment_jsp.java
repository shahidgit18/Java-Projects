...
public final class Payment_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<h4 class=\"title\"><span class=\"text\"><strong>Payment</strong> </span></h4>\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("                                                ");
      ...
      out.write("\n");
      out.write("                                                <form action=\"paymentcode.jsp\" method=\"post\" class=\"form-stacked\">\n");
      out.write("\t\t\t\t\t\t\t<fieldset>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"control-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"control-label\">ID</label>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("                                                                            <input type=\"text\" placeholder=\"Enter Payment ID\" readonly=\"true\" class=\"input-xlarge\" value=\"");
      out.print(maxid);
      ...
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("                                                                            <input type=\"text\" placeholder=\"Enter Payment Date\" class=\"input-xlarge\" readonly=\"true\" value=\"");
      out.print(dt1);
      out.write("\" name=\"txtdate\">\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"control-group\">\n");
      ...
      out.write("\" readonly=\"true\" placeholder=\"Enter Order Id\" class=\"input-xlarge\" name=\"txtorderid\">\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"control-group\">\n");
      ...
      out.write("\n");
      out.write("                                                                            <input type=\"text\" placeholder=\"Enter Amount\" value=\"");
      out.print(amt);
      out.write("\"  readonly=\"true\" class=\"input-xlarge\" name=\"txtamt\">\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"control-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"control-label\">GST:</label>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" placeholder=\"Enter Gst\" value=\"");
      out.print(session.getAttribute("gsttot"));
      out.write("\" readonly=\"true\" class=\"input-xlarge\" name=\"txtgst\">\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"control-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"control-label\">Payment Grand:</label>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" placeholder=\"Enter Payment Grand\" value=\"");
      out.print(session.getAttribute("gtotal"));
      out.write("\" readonly=\"true\" class=\"input-xlarge\" name=\"txtgrand\">\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t                            \n");
      out.write("\t\t\t\t\t\t\t\t\n");
