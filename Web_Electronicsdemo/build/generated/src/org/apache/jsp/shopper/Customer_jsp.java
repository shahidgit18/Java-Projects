...
public final class Customer_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tvar name = document.getElementById(\"txtcustnm\");\n");
      out.write("\tvar addr =document.getElementById(\"txtcustaddr\");\n");
      out.write("        var phno =document.getElementById(\"txtcustphno\");\n");
      out.write("\tvar email = document.getElementById(\"txtcustemail\");\n");
      out.write("        var pass = document.getElementById(\"txtcustpass\");\n");
      ...
      out.write("                        {\n");
      out.write("                            if(notEmpty(pass ,\"Password Must be given\") &&  lengthRestriction(pass,4,8))\n");
      out.write("                            {\n");
      ...
      out.write("                                                                            <form action=\"customercode.jsp\" method=\"post\" class=\"form-stacked\">\n");
      out.write("\n");
      out.write("\t\t\t\t<div class=\"row\">\n");
      out.write("                                   <div class=\"span12\">\t\t\t\t\t\n");
      out.write("\t\n");
      out.write("                                    <h4 class=\"title\"><span class=\"text\"><strong>Customer</strong> Form</span></h4>\n");
      out.write("                                   </div>\n");
      out.write("                                </div>\n");
      out.write("                                 <div class=\"row\">\n");
      out.write("\n");
      ...
      out.write("                                                    ");
                                                    ...
                                                    demo d=new demo();
                                                    int maxid=d.GetNewID("customer_master","cust_id");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" readonly=\"true\" placeholder=\"Enter Customer ID\" class=\"input-xlarge\" value = \"");
      out.print(maxid);
      out.write("\" name=\"txtcustid\">\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"control-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"control-label\">Name:</label>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" placeholder=\"Enter Customer name\" class=\"input-xlarge\" name=\"txtcustnm\" id=\"txtcustnm\">\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"control-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"control-label\">Address:</label>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("                                                                            <input type=\"text\" placeholder=\"Enter Customer address\" class=\"input-xlarge\" name=\"txtcustaddr\" id=\"txtcustaddr\">\n");
      out.write("                                                                        </div>\n");
      out.write("                                                                        </div>\n");
      out.write("                                                                        \n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" placeholder=\"Enter Customer Phone No\" class=\"input-xlarge\" name=\"txtcustphno\" id=\"txtcustphno\">\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\t\n");
      out.write("                                                            <div class=\"control-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"control-label\">Email:</label>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("                                                                            <input type=\"text\" placeholder=\"Enter Customer Email\" class=\"input-xlarge\" name=\"txtcustemail\" id=\"txtcustemail\">\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("                                                            <div class=\"control-group\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<label class=\"control-label\">Password:</label>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"controls\">\n");
      out.write("                                                                            <input type=\"text\" placeholder=\"Enter Customer password\" class=\"input-xlarge\" name=\"txtcustpass\" id=\"txtcustpass\">\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<hr>\n");
